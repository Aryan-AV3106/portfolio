            ...
            <section id="projects" className="w-full max-w-4xl mt-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-900 p-5 rounded-lg border border-gray-800 hover:border-purple-500 transition">
                        ...
                        <a
                            href="https://github.com/Aryan-AV3106/expense-tracker-cli"
                            target="_blank"
                    ...
                    {/* Cafeteria POS Java */}
                    <div className="bg-gray-900 p-5 rounded-lg border border-gray-800 hover:border-purple-500 transition">
                        <h4 className="text-lg font-semibold">Cafeteria POS System</h4>
                        <p className="text-gray-400 text-sm mt-2">
                            A Java-based Cafeteria POS system for managing billing & inventory.
                        </p>
                        <a
                            href="https://github.com/Aryan-AV3106/CafeteriaPOS-Java"
                            target="_blank"
                            className="text-purple-400 hover:underline text-sm mt-3 inline-block"
                        >
                            View Code →
                    ...
                    <div className="bg-gray-900 p-5 rounded-lg border border-gray-800 hover:border-purple-500 transition">
                        <h4 className="text-lg font-semibold">Simple Library Management</h4>
                        <p className="text-gray-400 text-sm mt-2">
                            A basic Java project to manage books, members, and transactions.
                        </p>
                        <a
                            href="https://github.com/Aryan-AV3106/simple-library-management"
                            target="_blank"
                            className="text-purple-400 hover:underline text-sm mt-3 inline-block"
                        >
                            View Code →
